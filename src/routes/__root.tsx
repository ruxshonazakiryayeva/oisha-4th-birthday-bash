...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Oishaning 4 yoshlik tug'ilgan kuniga taklifnoma" },
      { name: "author", content: "WebInvite" },
      { property: "og:title", content: "Oisha 4 yoshga to'ldi — Taklifnoma" },
      { property: "og:description", content: "Oishaning 4 yoshlik tug'ilgan kuniga taklifnoma" },
